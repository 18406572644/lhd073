...
import { LayoutDashboard, FolderOpen, TrendingUp, Search, LogOut, Plus, Scan, ShieldCheck, Dna, HeartPulse, FileText, Share2, Monitor } from 'lucide-vue-next'
...
const menuOptions = [
  ...
  },
  {
    label: '大屏模式',
    key: '/bigscreen',
    icon: () => h(NIcon, { size: 20 }, { default: () => h(Monitor) }),
  },
]
